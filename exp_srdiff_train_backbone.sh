...
# srun python trainer.py --config configs/diffsr_maxvit_ltae.yaml --config_file flair-config-server.yml --exp_name misr/srdiff_highresnet_ltae_ckpt --hparams="cond_net_ckpt=/bigwork/nhgnkany/Results/LDM_LCC_FLAIR_HUB_HR_Res_DSat/results/checkpoints/misr/highresnet_ltae_ckpt" --reset
